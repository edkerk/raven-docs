...
>
> Every page's Python output blocks are generated by the runner and re-checked in
> CI; the MATLAB tabs carry no output until a MATLAB harness exists. **5 of the
> 13 P1 pages are written.**
>
